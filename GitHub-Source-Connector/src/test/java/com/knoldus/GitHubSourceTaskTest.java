...
import com.knoldus.model.Issue;
...
public class GitHubSourceTaskTest {
    ...
    public void test() throws UnirestException {
        ...
        if (httpResponse.getStatus() != 403) {
            ...
            assertTrue(headers.contains(GitHubAPIHttpClient.X_RATELIMIT_LIMIT_HEADER));
            assertTrue(headers.contains(GitHubAPIHttpClient.X_RATELIMIT_REMAINING_HEADER));
            assertTrue(headers.contains(GitHubAPIHttpClient.X_RATELIMIT_RESET_HEADER));
